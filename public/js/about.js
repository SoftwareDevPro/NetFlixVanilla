...
// Grab the movie identifer from the URL path /:id
...
.then(data => {
    ...
    for(let i = 0; i < maxClips; i++){
        ...
        <iframe src="https://youtube.com/embed/${data.results[i].key}" title="YouTube video player" frameborder="0" allowfullscreen></iframe>
        `;
    }
})
